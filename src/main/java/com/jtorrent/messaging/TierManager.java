 ...
 * @see <a href="http://www.bittorrent.org/beps/bep_0012.html">Metadata Extension</a>
 * @author Alex
 *
 */
public class TierManager {
	...
	private List<List<TrackerClient>> provideTierList(List<List<URI>> announceList) {
		// The announce list has been parsed from the metainfo file. Now a connection
		// needs to be made between the torrent client and a tracker.
		
		// All the URIs are converted to TrackerClients and the client which will be 
		// queried is determined as described in BEP #12 - the tier list is created
		// by shuffling every tier and adding it to a larger pool which contains all
		// tier lists.
	...
	/**
	 * Moves the last tracker, to which the client connected to successfully, to the front
	 * of the tier list as described in BEP #12.
	 */
